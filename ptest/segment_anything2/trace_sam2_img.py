...
class Sam2Wrapper(nn.Module):
    ...
    def prompt_encode(self, coords, labels):
        ...
        sparse_embeddings = torch.empty((1, 0, self.model.sam_prompt_encoder.embed_dim), device=device)
...
if __name__ == "__main__":
    hf_model_id = sys.argv[1] if len(sys.argv) > 1 else "facebook/sam2-hiera-tiny"
