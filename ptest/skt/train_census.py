# Training scikit learn model for Census Income
...
# gcloud storage cp gs://cloud-samples-data/ai-platform/sklearn/census_data/* .
...
for i, col in enumerate(COLUMNS[:-1]):
    if col in CATEGORICAL_COLUMNS:
        ...
        categorical_pipelines.append(
            ("categorical-{}".format(i), Pipeline([("SKB-{}".format(i), skb), ("LBN-{}".format(i), lbn)]))
        )
