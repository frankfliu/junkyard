...
ADD_LDFLAGS += -L$(DEPS_PATH)/lib /usr/local/cuda/lib64/libculibos.a -lpng -ltiff -ljpeg -lz -ldl -lgfortran -Wl,--version-script=$(BASEDIR)/config/libmxnet.ver,-rpath,'$${ORIGIN}',--gc-sections
